...
PETR <- getSymbols("PETR4.SA", auto.assign = FALSE, from="2020-01-02", to="2024-12-31")
...
ggplot(PETR.df) + 
  ...
  geom_histogram(aes(x = R_petr, y=after_stat(density)), fill = "blue", alpha = 0.5, colour =  "black", bins = 50) +
